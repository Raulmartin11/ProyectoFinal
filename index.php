  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr align="center" id="comentario_<?= $comentario->idComentario ?>" data-idcomentario="<?= $comentario->idComentario ?>">
          <td colspan="2">
            <?php if($_SESSION['admin'] === '1'): ?>
              <button class="close" name="delete" value="<?= $comentario->idComentario ?>">&times;</button>
            <?php endif; ?>
    ...
    $(document).ready(function() {
      var idComentario;
        ...
        $( "#dialogoborrar" ).dialog({
          ...
          "Borrar": function() {
            //Ajax con get
            $.get("borrarComentario.php", {"idComentario":idComentario},function(data,status){
              $("#comentario_" + idComentario).fadeOut(500);
            })//get
      ...
      $(document).on("click",".close",function(){
        ...
        idComentario = $(this).parents("tr").data("idcomentario");
